...
#with rmse 
Metrics::rmse(test$CHI_MLU, predict(simple, newdata = test, allow.new.levels = T)) # 1.3 
Metrics::rmse(test$CHI_MLU, predict(big_model, newdata = test, allow.new.levels = T)) # .6
