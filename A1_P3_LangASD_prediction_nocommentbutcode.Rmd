...
#predicting with cross-validation models & with models from last time 
...
as.table(c(cross_simple, cross_big, simple_rmse, big_rmse))
...
#data_3 <- filter(data_3, SUBJ != "1" | VISIT != "2")

data_full_TD <- filter(data_3, Diagnosis == "TD") #why use data_3 now, and not the new "full"?
filter(data_full, Diagnosis == "TD") %>% abs(mean(BernieData$CHI_MLU) - mean(data_full$CHI_MLU))
#I get an error here 
